...
- 📡 **Modo Auto-Sintonización Dinámica en Vivo (`[AA]`):** Escucha todos los canales conocidos y, si la señalización anuncia una nueva portadora dentro del ancho de banda ($2.048\text{ MHz}$), **la sintoniza automáticamente en caliente en tiempo real**, guardando las frecuencias externas en `nuevas_frecuencias.txt`.
